...
app = Flask(__name__, template_folder=os.path.join(os.path.dirname(os.path.abspath(__file__)), 'AI-Fitness-trainer-main'), static_folder=os.path.join(os.path.dirname(os.path.abspath(__file__)), 'AI_FITNESS_PROJECT', 'assets'))
@app.route('/blog1')
def blog1():
...
def start_exercise1():
    exercise = request.form['exercise']
    script_path = os.path.join(os.path.dirname(__file__), 'main1.py')
    command = f'python "{script_path}" -t {exercise}'
